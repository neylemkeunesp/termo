...
\frame{\frametitle{Bibliografia} Dill, K. A. Bromberg, S. ``Molecular
  Driving Forces'', Garlanc Science, (2002).  }

\frame{\frametitle{Esquema do Curso}
  \begin{itemize}
  \item Revisão Matemática
  \item Princípios de Extremização
  \item Calor, Trabalho e Energia
  \item Entropia
  \item Forças Termodinâmicas
  \item Energias Livres
  \end{itemize}
} \frame{\frametitle{Esquema do Curso}
  \begin{itemize}
  ...
  \item Capacidade Térmica
  \end{itemize}

} \frame{\frametitle{Seminários}
  \begin{itemize}
  \item Equíbrio Químico
  \item Difusão
  \item Soluções e Misturas
  \item Cinética Química
  \item Equilíbrio Eletroquímico
  \item Transições de Fases
  \end{itemize}
}
...
em equilíbrio, assim como $B$ e $C$ então $A$ e $C$ estão em equlíbrio.
...
para as leis da Termodinâmica. Nos primordios a esperança era usar 
