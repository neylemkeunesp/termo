...
\frame{\frametitle{Não Conservação}
  ...
  \item Experimento de fracassado de ``Ericsson em 1853''.
  \end{itemize}
  \begin{center}
...
\frame{\frametitle{Fluxo de Energia}
  ...
  simetrica e para o caso em que isto não ocorre. Se convença que a
...
situação em que o sistema $A$ possui duas partículas no extado excitado
e $B$ 4 partículas.
...
e  duas partículas no extado excitado
