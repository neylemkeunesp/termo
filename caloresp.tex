...
\frame{\frametitle{Sistema de dois estados:}
  \begin{description}
  \item[$T>0$] Para sistemas com baixa energia a temperatura é positiva. Estes sistemas abosorvem energia para atingir o máximo da multiplicidade.
\item[$T=0$] Estes sistemas possuem metade dos átomos em cada nível de energia. 
...
$W(E)$ é a denisdade de estados, ou seja o número de estados com uma determinada
energia $E$.
