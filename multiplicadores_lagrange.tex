...
\begin{tikzpicture}[
  scale=0.1,
  node distance=.6cm and .5cm,
  box/.style={rectangle, rounded corners, draw=gray, fill=black!80, text width=10cm, minimum height=.6cm, text centered, font=\small\color{white}},
