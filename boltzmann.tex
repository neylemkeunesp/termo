...
Esta propriedade é chamada de Extensividade. A Entropia oriunda históricamente 
...
informação que eu recebo ao ser comunicado do reultado de um evento
aleatório.
...
A variável de interesse nesse caso é a freq. de ocorrencia de cada um
dos lados.
...
\frame{\frametitle{Questões Filosóficas}
  \begin{itemize}
  \item Qual é a o origem probabilística da Entropia?
  \item Compatibilidade entre a Termodinâmica e e Mecânica Estatística.
...
O razão do número de partículas é:
...
Em um sistema, os estados com probabiliade de ocupação razoável satisfazem 
$E\sim kT$, pois se $E>kT$ seu peso de Boltzmann é muito pequeno,
$E<k T$ sua multiplicidade $W$ é muito pequena. 
}

 \frame{\frametitle{Distribuição de Boltzman}
 \begin{tabular}{c c}
     \begin{minipage}{0.45\textwidth}
...
os vínculos do sistema. na Mecânica Estatística trabalamos com 
3 Ensembles:
\begin{description}
