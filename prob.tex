...
Os eventos $A$ e $B$ são mutuamente exclusivos se a ocorrência de $A$ impede a ocorrência de $B$ e veice-versa. Ou seja se $A\cap B =\emptyset$.
...
Qual é a probabilidade de se obter um dado 1 no primeiro lançamentp ou um dado 4 no segundo?
}
